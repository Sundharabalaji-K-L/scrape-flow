...
const WorkflowCard = ({workflow}: {workflow: Workflow}) => {
    ...
    return (
       <Card className="border border-separate
       shadow-sm rounded-lg overflow-hidden hover:shadow-md dark:shadow-primary/30">
...
function WorkflowActions({workflowName, workflowId}: {workflowName: string, workflowId: string}) {
    ...
    return (
      <>
          ...
          <DeleteWorkflowDialog open={showDeleteDialog}
